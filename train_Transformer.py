...
def create_parser():
    parser = argparse.ArgumentParser(
        description="Temporal Transformer 模型训练脚本。",
    ...
    parser.add_argument("--temporal-pool", type=str, default=Config.temporal_pool, choices=["mean", "max", "cls"], help="时间维聚合方式。")
...
def main():
    ...
    run_training("TemporalTransformer", args)
