...
def create_parser():
    parser = argparse.ArgumentParser(
        description="Train the ConvLSTM model.",
...
def build_cfg_from_args(args):
    base_cfg = Config()
    experiment_name = str(args.experiment_name or "").strip() or get_default_experiment_name("ConvLSTM")
    ...
    return SimpleNamespace(
        ...
        vit_embed_dim=base_cfg.vit_embed_dim,
        vit_depth=base_cfg.vit_depth,
        vit_num_heads=base_cfg.vit_num_heads,
        vit_mlp_ratio=base_cfg.vit_mlp_ratio,
        vit_dropout=base_cfg.vit_dropout,
        vit_attn_dropout=base_cfg.vit_attn_dropout,
...
def run_training(cfg):
    ...
    logger, log_file = setup_logging(cfg.log_dir, "train_convlstm")
    ...
    logger.info(
        ...
        f"convlstm_hidden={cfg.convlstm_hidden}, convlstm_layers={cfg.convlstm_layers}, seed={cfg.seed}"
    )
